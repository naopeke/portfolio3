...
const Card = ({
  ...
  return (
    <div
      ...
      className="relative border border-black/[0.2] group/canvas-card flex items-center justify-center dark:border-white/[0.2]  max-w-sm w-full mx-auto p-4 lg:h-[30rem]"
    >
      ...
      <div className="relative z-20 px-10">
        <div className="absolute  top-[50%] left-[50%] translate-x-[-50%] tranlate-y-[-50%] text-center group-hover/canvas-card:-translate-y-4 group-hover/canvas-card:opacity-0 transition duration-200 w-full  mx-auto flex items-center justify-center">
          {icon}
        </div>
